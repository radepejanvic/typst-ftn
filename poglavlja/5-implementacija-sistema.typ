...
9. додавање дозволе за покретање `node_start.sh` скрипте

На листингу #link(<lst:node_env>)[13] приказан је део променљивих окружења дефинисаних у датотеци `node.env`. Оне се аутоматски генеришу за сваки чвор током процеса иницијализације и садрже информације неопходне за правилно повезивање чворова са _control plane_-ом и међусобну комуникацију у оквиру кластера.
